...
class AddbossitemController extends Controller
{
    public function process($parameters)
    {
        if($_SESSION["user"]["admin"] == 1)
        {
            ...
            $sql = "SELECT bi.idBosses, b.nameBoss, b.difficulty, d.nameDifficulty, d.pNumber, bi.idItems, i.nameItem FROM bosses b INNER JOIN bosses_has_items bi USING(idBosses) INNER JOIN items i USING(idItems) INNER JOIN difficulty d ON(b.difficulty=d.idDifficulty)";
